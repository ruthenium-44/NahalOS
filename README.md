...
<h1 align="center">NahalOS v0.5 💢 </h1>
...
Дополнительные материалы к обновлениям ждут вас в Discussions!
 
✅ **Вариватт не работал. Переделали (айайай гайвер)**  

✅️ **Сделали анимацию парения с таймером тяги**

Но не отобразили его на экранах всех режимов, это будет в следующем обновлении.

✅️ **Убрали спам сохранения тяг в EEPROM**

✅️ **Изменили сообщение об отсечке**
