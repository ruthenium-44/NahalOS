...
## Обновление v0.4.1BETA🔄

🎉 **Вышли из альфа-версии**  
 
✅ **Дорисовали меню для всех режимов**  

✅️ **Изменили логику режима установки сопротивления**

✅️ **Доработали меню вариватта**

✅️ **Теперь нельзя случайно менять режимы в версии без дисплея**
...
Это версия с дисплеем и кучей менюшек с интерфесом для каждой.
...
| SET    |         Удеражание: Показать инфу об аккамуляторах<br/>Нажатие: Переключение режимов по кругу         |
