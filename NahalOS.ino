    ...
    if (vape_state && !vape_btt_f) {
      ...
      switch (click_count) {
        case 1:
          ...
          display.setTextColor(WHITE);
          display.setCursor(15, 25);
          display.println("5 raz i budet gaz");
          display.display();
          break;
        case 2:
          display.clearDisplay();
        ...
        case 4:
          ...
          display.setCursor(15, 25);
          display.println("5 raz i budet gaz");
          display.fillRect(0, 40, 130, 10, WHITE);
          display.display();
          break;
      }
...
void vavaDis() {
  ...
  display.drawLine(74, 31, 74, 49, INVERSE);  // плахи
  display.drawLine(80, 31, 80, 49, INVERSE);
  display.drawLine(86, 31, 86, 49, INVERSE);
  display.drawLine(92, 31, 92, 49, INVERSE);
  display.drawLine(98, 31, 98, 49, INVERSE);
  display.drawLine(104, 31, 104, 49, INVERSE);
  display.drawLine(110, 31, 110, 49, INVERSE);
  display.drawLine(116, 31, 116, 49, INVERSE);
  display.drawLine(122, 31, 122, 49, INVERSE);  // плахи
  display.drawLine(68, 40, 128, 40, INVERSE);
